...
const theme: Partial<Config['theme']> = {
    extend: {
        ...
        } as Record<string, KeyframeDefinition>
    },
    animation: {
    ...
    animationOpacity: ({ theme }: { theme: (path: string) => any }) => theme('opacity'),
    animationTranslate: ({ theme }: { theme: (path: string) => any }) => theme('translate'),
    animationScale: ({ theme }: { theme: (path: string) => any }) => theme('scale'),
    animationRotate: ({ theme }: { theme: (path: string) => any }) => theme('rotate')
};
